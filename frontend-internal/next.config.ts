...
// (e.g. nginx /api) NEXT_PUBLIC_API_URL is relative, origin resolves empty, and
// 'self' already covers it. Tightening to a nonce-based strict CSP (via proxy.ts
// + 'strict-dynamic') is a follow-up.
const apiOrigin = (() => {
  try {
