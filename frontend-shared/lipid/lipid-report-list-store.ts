...
// Separate from the hipertensi and DM stores on purpose: the three registries
// are different pages, and a puskesmas/year picked on one must not silently
// re-scope the others.
export const useLipidReportListStore = create<State>((set) => ({
  puskesmasId: "",
  year: _NOW_YEAR,
  q: "",
  page: 1,
